...
public class TelegramMessageConsumer {
    ...
    public void processsReport(TelegramUpdateDto payload) {
        try {
           log.info("[Infra - RabbitMQ - Report] Mensagem capturada da fila!");
